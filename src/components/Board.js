    ...
    return (
      <div className="board">
        <div className="game-info">
          <h1>Welcome to the game of Minesweeper!</h1>
          <span className="info">Remaining mines: {this.state.mineCount}</span>
          <h3 className="info">{this.state.gameStatus}</h3>
          <div className="play">{!this.state.gameStart && this.state.span}</div>
        </div>
